...
#setwd('O:/Harvard/Hwang/STARRSLS/AnalyticFiles_NEW/6_LSW4_variables/Separation_analysis_makedata/Update_202503/Analysis/RESULTS/risk_sdonly/')
...
setwd('/home/data/Harvard/Hwang/STARRSLS/AnalyticFiles_NEW/6_LSW4_variables/Separation_analysis_makedata/Update_202503/Analysis/RESULTS/risk_sdonly/')
...
saveRDS(cv_lasso,'risk_sdonly.rds')

#cv_lasso <- readRDS('risk_sdonly.rds')
...
write.csv(lasso_coefs,'sdonly_lasso_coefs.csv',row.names=F)
write.csv(shap_data,'sdonly_shapdata.csv',row.names=F)
...
saveRDS(xgbFit,'xgbFit_sdonly.rds')

#xgbFit <- readRDS('xgbFit_sdonly.rds')  

#shap_data<-read.csv('sdonly_shapdata.csv')
...
write.csv(xgb_shap,'sdonly_xgb_shap.csv',row.names=F)
write.csv(shap_table,'sdonly_shap_table.csv',row.names=F)