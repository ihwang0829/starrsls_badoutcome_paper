...
setwd('/home/data/Harvard/Hwang/STARRSLS/AnalyticFiles_NEW/6_LSW4_variables/Separation_analysis_makedata/Update_202503/Analysis/RESULTS/risk_2plus/')
...
saveRDS(cv_lasso,'risk_2plus.rds')
...
write.csv(lasso_coefs,'risk_2plus_lasso_coefs.csv',row.names=F)
write.csv(shap_data,'risk_2plus_shapdata.csv',row.names=F)
...
saveRDS(xgbFit,'xgbFit_risk_2plus.rds')
...
write.csv(xgb_shap,'risk_2plus_xgb_shap.csv',row.names=F)
write.csv(shap_table,'risk_2plus_shap_table.csv',row.names=F)