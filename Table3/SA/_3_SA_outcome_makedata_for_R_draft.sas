...
libname out "&pathO./Harvard/Hwang/STARRSLS/AnalyticFiles_NEW/6_LSW4_variables/Separation_analysis_makedata/data/cvtemps/SA/";
...
%LET output2=&pathO./Harvard/Hwang/STARRSLS/AnalyticFiles_NEW/6_LSW4_variables/Separation_analysis_makedata/data/cvtemps/SA/; 
...
*/ 
proc sort data=sepfile._outcomesf_SA out=saoutcome;
 by masterid ;
run;
...
tables fold;
run;
proc sort data=full_data_with_fold; by fold;
proc freq data=full_data_with_fold;
tables SA_outcomef;
...
proc freq data=full_data_with_fold;
tables stack*fold*SA_outcomef
/list missing;
run;

data sepfile.full_data_with_fold_SA;
...
/*
combine dischargetype_cat3 dischargetype_cat4 
...
if dischargetype_cat4=1 then dischargetype_cat3=1; 
