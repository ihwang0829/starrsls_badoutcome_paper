...
%calc_lasso(type=lasso,dir=HL/yr1/,pre=hl,outcome=hl_final,        pp=cv_pred_lasso, csv=cv_pred_lasso, outfile1=hl_yr1_ppauc,   outfile2=hl_yr1_CRtables)
...
%calc_lasso(type=lasso,dir=SA/yr1/,pre=sa,outcome=SA_outcomef,     pp=sacv_pred_lasso, csv=sacv_pred_lasso, outfile1=sa_yr1_ppauc,   outfile2=sa_yr1_CRtables)
 
%calc_lasso(type=lasso,dir=EM/,    pre=em,outcome=unempoutcome,     pp=emcv_pred_lasso, csv=emcv_pred_lasso, outfile1=em_total_ppauc, outfile2=em_total_CRtables)
%calc_lasso(type=lasso,dir=EM/yr1/,pre=em,outcome=unempoutcome,     pp=emcv_pred_lasso, csv=emcv_pred_lasso, outfile1=em_yr1_ppauc,   outfile2=em_yr1_CRtables)
